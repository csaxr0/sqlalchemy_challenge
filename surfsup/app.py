...
def precipitation():
    print(" Climate app precipitation page...")
...
def stations():
    print("Climate app station data...")
...
def tobs():
    print("Climate app temp observation data for previous year ...")
...
def temps_from_start(start):
    ...
    print(f"Climate app daily normals from {start}...")
